...
<head>
    ...
    <title>Lodging Details Records</title>
        ...
        <li>
          ...
          <li>
            ...
            <div id="info">
                <br>
              <center>
                <h3 style="font-size:30px;" id="infor">Lodging Details of registered Students</h3>
                <br>
                    <h4 style="font-size:20px;" id="note"> 
                        The following table contains the Lodging and mess details of registered students. This includes residential status, dorm they are in, room number,
                        TAF number and so on.
                    </h4>
                </center>  
            </div>
            <br>
            <table class="table">
                ...
                $sql="SELECT StudentID,FirstName,LastName,Gender,Resident,Dorm,RoomNo,TAFNo,Allergies FROM lodging";
